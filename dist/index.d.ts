 ...
 * import type * as mathType from './math.js';
 *
...
export { Worker, type ThreadWorkerOptions } from './node/worker.js';
/**
...
export { FunctionPool, type FunctionPoolOptions } from './function/function-pool.js';
export { importTaskWorker, importWorker, importPersistentWorker, setWorkerFile, getWorkerFile, } from './function/main-thread.js';
/**
...
export { WebFunctionPool, type WebFunctionPoolOptions } from './web/function-pool.js';
export { importTaskWebWorker, importWebWorker, importPersistentWebWorker, setWorkerUrl, getWorkerUrl, type WorkerOptions, } from './web/main-thread.js';
/**
