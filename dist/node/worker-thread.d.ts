...
import { Worker, type ThreadWorkerOptions } from './worker.js';
 ...
 */
export type WorkerThreadOptions = [file: string | URL, options: ThreadWorkerOptions, meta: any] | [file: string | URL, options: ThreadWorkerOptions] | [options: ThreadWorkerOptions];
/**
...
export declare class WorkerThread extends EventEmitter {
     ...
     * ```
     */
    finally(onFinally: (exitCode: any) => void): this;
}
