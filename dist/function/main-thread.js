...
const workerPromise = (worker, message, messageOptions = {}) => {
    const { timeout } = { ...{ timeout: 30000 }, ...messageOptions };
    return new Promise((resolve, reject) => {
        let timeoutID = null;
        const cleanupListeners = (cb, response, eventType = null) => {
 ...
 * ```
 */
const importTaskWorker = (filename, workerOptions = {}, messageOptions = {}) => {
 ...
 * ```
 */
const importPersistentWorker = (filename, workerOptions = {}, messageOptions = {}) => {
    return importWorkerProxy(filename, {
        isBrowser: false,
        isSharedWorker: false,
        isPersistent: true,
...
export { getWorkerFile, importPersistentWorker, importTaskWorker, importWorker, setWorkerFile };
