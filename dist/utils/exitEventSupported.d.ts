 ...
 * @constant {string}
 */
export declare const exitKey = "@@TerminateThread";
/**
 ...
 * ```
 */
export declare const exitEventSupported: (delay?: number) => Promise<boolean>;
/**
 ...
 * ```
 */
export declare const close: (parentPort: any) => void;
//# sourceMappingURL=exitEventSupported.d.ts.map